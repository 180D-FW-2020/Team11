...
while True:
    ...
    if 1:                       #Change to '0' to stop showing the angles from the accelerometer
        outputString += "# ACCX/Y %5.2f/%5.2f " % (AccXangle, AccYangle)

    if 1:                       #Change to '0' to stop  showing the angles from the gyro
        outputString +="# GRYX/Y/Z %5.2f/%5.2f/%5.2f " % (gyroXangle,gyroYangle,gyroZangle)

    if 1:                       #Change to '0' to stop  showing the angles from the complementary filter
        outputString +="# CFangleX/Y %5.2f/%5.2f " % (CFangleX,CFangleY)

    if 1:                       #Change to '0' to stop  showing the heading
        outputString +="# HEADING/tc %5.2f/%5.2f " % (heading,tiltCompensatedHeading)

    if 1:                       #Change to '0' to stop  showing the angles from the Kalman filter
        outputString +="# kalmanX/Y %5.2f/%5.2f # \n" % (kalmanX,kalmanY)
